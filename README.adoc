...
The rule file is a YAML file (or JSON, as it is a subset of YAML), consisting
...
[source,sh-session]
-----------------------------------------------------------
$ ip2unix rules-server.yaml python -m SimpleHTTPServer 8000
-----------------------------------------------------------
...
[source,sh-session]
------------------------------------------------
$ ip2unix rules-client.yaml curl http://1.2.3.4/
------------------------------------------------
